...
public:
  Adafruit_BusIO_Register(Adafruit_I2CDevice_Adapter *i2cdevice, uint16_t reg_addr,
                          uint8_t width = 1, uint8_t byteorder = LSBFIRST,
                          uint8_t address_width = 1);

  Adafruit_BusIO_Register(Adafruit_SPIDevice_Adapter *spidevice, uint16_t reg_addr,
                          Adafruit_BusIO_SPIRegType type, uint8_t width = 1,
                          uint8_t byteorder = LSBFIRST,
                          uint8_t address_width = 1);

  Adafruit_BusIO_Register(Adafruit_I2CDevice_Adapter *i2cdevice,
                          Adafruit_SPIDevice_Adapter *spidevice,
...
private:
  Adafruit_I2CDevice_Adapter *_i2cdevice;
  Adafruit_SPIDevice_Adapter *_spidevice;

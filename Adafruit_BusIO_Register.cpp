 ...
 * to 1 byte
 */
Adafruit_BusIO_Register::Adafruit_BusIO_Register(Adafruit_I2CDevice_Adapter *i2cdevice,
                                                 uint16_t reg_addr,
                                                 uint8_t width,
                                                 uint8_t byteorder,
 ...
 * to 1 byte
 */
Adafruit_BusIO_Register::Adafruit_BusIO_Register(Adafruit_SPIDevice_Adapter *spidevice,
                                                 uint16_t reg_addr,
...
Adafruit_BusIO_Register::Adafruit_BusIO_Register(
    Adafruit_I2CDevice_Adapter *i2cdevice, Adafruit_SPIDevice_Adapter *spidevice,
